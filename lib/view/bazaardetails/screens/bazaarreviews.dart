  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Obx(() {
            final currentBazaar = controller.bazaar.value;
            ...
            return currentBazaar.reviews.isNotEmpty
                ? Expanded(
                    child: Padding(
                        ...
                        child: RefreshIndicator(
                            onRefresh: () => controller
                                .fetchBazaar(controller.bazaar.value!.id),
                            child: ListView.builder(
                              clipBehavior: Clip.none,
                              itemCount: currentBazaar.reviews.length,
                              itemBuilder: (context, index) {
                                final review = currentBazaar.reviews[index];
                                return Container(
