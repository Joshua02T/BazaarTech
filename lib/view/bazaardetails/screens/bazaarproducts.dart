...
import 'package:bazaartech/view/bazaardetails/controller/bazaarproductscontroller.dart';
...
class BazaarProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(BazaarProdcutsController(category.id.toString()));
    return Scaffold(
      backgroundColor: AppColors.backgroundColor,
      appBar: CustomAppBarWithBack(text: category.name),
      body: GetBuilder<BazaarProdcutsController>(
        builder: (controller) {
