...
class ProductDefaultAndSave extends StatelessWidget {
  final void Function() onPressed;
  const ProductDefaultAndSave({super.key, required this.onPressed});
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          MaterialButton(
            onPressed: () {
              if (controller.filterProductKey.currentState!.validate()) {}
            },
